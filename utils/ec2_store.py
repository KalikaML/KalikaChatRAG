# This Python script connects to a PostgreSQL database, creates an orders table 
# if it doesn't already exist, and provides a function to insert new order records into that table. 
# It uses environment variables for database credentials and includes a sample usage to test storing an order.
