# This code automates the retrieval of purchase order (PO) PDF attachments from email, uploads them to AWS S3, and processes their contents to build a searchable FAISS vector index using language embeddings. 
# It streamlines PO management by enabling efficient document storage, deduplication, and semantic search capabilities for procurement workflows.
